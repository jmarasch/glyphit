...
export const migrate = async (plugin: GlyphItPlugin): Promise<void> => {
  // @ts-expect-error - Required because an older version of the plugin saved the
  // `migrated` property as a boolean instead of a number.
